...
/**
 * ZNT brand mark — the site's accent gradient on a rounded tile with a
 * solid geometric Z. Rendered inline (with a unique gradient id) so it can
...
export function Logo({ size = 30, className }: LogoProps) {
  ...
  return (
    ...
    >
      ...
      <path d="M20 18H44V25L30 39H44V46H20V39L34 25H20Z" fill="#fff" />
    </svg>
  );
}
